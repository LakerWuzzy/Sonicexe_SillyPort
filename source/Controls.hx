...
class Controls extends FlxActionSet
{
	...
	public function setHitBox(Hitbox:FlxHitbox)
	{
		...
		inline forEachBound(Control.SPACEB, (action, state) -> addButtonNOTES(action, Hitbox.buttonUp, state));
	...
	public function setVirtualPadUI(VirtualPad:FlxVirtualPad, DPad:FlxDPadMode, Action:FlxActionMode)
	{
		switch (DPad)
		{
			case UP_DOWN:
				...
				inline forEachBound(Control.SPACEB, (action, state) -> addButtonUI(action, VirtualPad.buttonUp, state));
	...
	public function setVirtualPadNOTES(VirtualPad:FlxVirtualPad, DPad:FlxDPadMode, Action:FlxActionMode)
	{
		switch (DPad)
		{
			case UP_DOWN:
				...
				inline forEachBound(Control.SPACEB, (action, state) -> addButtonNOTES(action, VirtualPad.buttonUp, state));
